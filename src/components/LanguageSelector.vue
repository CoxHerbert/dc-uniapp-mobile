<template>
  <view>
    <wd-cell-group v-if="isCellVariant" :inset="inset" :class="cellGroupClass">
      <wd-cell :title="titleText" :value="currentLabel" is-link @click="openSheet" />
    </wd-cell-group>
    ...
    <button
      ...
      @click="openSheet"
    >
      <text class="language-trigger__label">{{ currentLabel }}</text>
      <wd-icon class="language-trigger__icon" name="arrow-down" />
    </button>
